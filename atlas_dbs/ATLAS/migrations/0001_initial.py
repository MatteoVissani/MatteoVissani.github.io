    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATLAS.atlas_paper')),
            ],
            options={
                'verbose_name': 'List of ATLAS',
                'verbose_name_plural': 'List of ATLASes',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atlas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATLAS.atlas_rep')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATLAS.atlas_paper')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='ATLAS.atlas_rep')),
            ],
            options={
                'verbose_name': 'List of File',
                'verbose_name_plural': 'List of Files',
            },
        ),
    ]
